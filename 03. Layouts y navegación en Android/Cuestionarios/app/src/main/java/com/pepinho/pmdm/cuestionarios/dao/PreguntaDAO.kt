package com.pepinho.pmdm.cuestionarios.dao
...
class PreguntaDAO {
    ...
    val preguntas: MutableList<Pregunta> = mutableListOf(
        PreguntaTest("Marca las respuestas correctas sobre la sintaxis de Kotlin:", 1).apply {
        ...
        PreguntaVerdaderoFalso("Los astronautas del Apolo 11 llegaron a la Luna en 1967", 2).apply {
            puntos = 1.0
            correcta = false
        },
        PreguntaTest("¿Cuál de las siguientes afirmaciones sobre Kotlin es correcta?", 3).apply {
            addOpcion(Opcion("Kotlin es un lenguaje de programación desarrollado por Google", false))
        ...
        PreguntaTest("¿Cuál es el libro más vendido de la historia?", 3).apply {
        ...
        PreguntaVerdaderoFalso("¿Es Kotlin el lenguaje de programación más usado en 2023?", 4).apply {
            puntos = 1.0
            correcta = false
        }
    )
