package com.pepinho.pokemonapi.presentation.screens.pokemon
...
@Composable
fun PokemonScreen(viewModel: PokemonViewModel = viewModel(), modifier: Modifier = Modifier, navController: NavController) {
    ...
    when (state) {
        ...
        is PokemonState.Success -> {
            ...
            PokemonGrid(
                ...
                onClick = { viewModel.getPokemonById(it) },
...
fun PokemonGrid(
    ...
    LazyVerticalGrid(
        ...
        items(pokemons.size) { index ->
            PokemonItem(pokemons[index], onClick = onClick, navController = navController)
        }
...
fun PokemonItem(pokemon: Pokemon, onClick : (Int) -> Unit = {},
    ...
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .aspectRatio(1f).padding(12.dp).clickable { navController.navigate("detail/$pokemonId") },
